...
content_copyright_association = Table(
    ...
    Column(
        "copyright_holder_id",
        Integer,
        ForeignKey("copyright_holder.copyright_holder_id", ondelete="CASCADE"),
        primary_key=True,
    ),
)
...
class CopyrightHolder(Base):
    ...
    contents = relationship(
        "Content",
        secondary=content_copyright_association,
        back_populates="copyright_holders",
    )
...
class Content(Base):
    ...
    copyright_holders = relationship(
        "CopyrightHolder",
        secondary=content_copyright_association,
        back_populates="contents",
        lazy="selectin",
