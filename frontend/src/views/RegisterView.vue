    ...
    <div class="card shadow-lg border-0 p-4" style="max-width: 450px; width: 100%;">
      ...
      <form @submit.prevent="handleRegister">
        <div class="mb-3">
          ...
          <input v-model="form.user_name" type="text" class="form-control shadow-none" required placeholder="IvanIvanov">
        </div>
        <div class="mb-3">
          <label class="form-label small fw-bold text-uppercase">Email</label>
          <input v-model="form.user_email" type="email" class="form-control shadow-none" required placeholder="ivan@example.com">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
          ...
          <input v-model="form.user_birth_date" type="date" class="form-control shadow-none" required>
        </div>
        <div class="mb-4">
          <label class="form-label small fw-bold text-uppercase">Пароль</label>
          <input v-model="form.user_password" type="password" class="form-control shadow-none" required placeholder="strongpassword123">
        </div>
