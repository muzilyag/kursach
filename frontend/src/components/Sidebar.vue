...
<template>
  <aside v-if="userRole" 
    ...
    <ul class="nav nav-pills flex-column mb-auto">
      ...
      <li class="nav-item">
        <RouterLink v-if="userRole === 'admin'" to="/admin/dashboard" class="nav-link text-white d-flex align-items-center" active-class="active" style="--bs-nav-pills-link-active-bg: var(--sidebar-primary);">
