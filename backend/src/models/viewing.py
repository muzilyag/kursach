...
class Viewing(Base):
    ...
    __table_args__ = (
        CheckConstraint(
            "viewing_progress >= 0 AND viewing_progress <= 100",
            name="viewing_percent_check",
        ),
    )
