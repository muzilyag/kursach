...
class RoleChecker:
    ...
    def __call__(self, user: User = Depends(get_current_user)):
        if user.user_role.value not in self.allowed_roles:
            raise HTTPException(
...
require_content_manager = RoleChecker(["content_manager", "admin", "superadmin"])
require_user = RoleChecker(["user", "content_manager", "admin", "superadmin"])
